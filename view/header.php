			...
			<div class="container">
				...
				<div class="row">
					...
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="http://localhost:83/loja-virutal/">Home</a></li>
							<li><a href="http://localhost:83/loja-virutal/videos">Videos</a></li>
							<li><a href="http://localhost:83/loja-virutal/shop">SHOP</a></li>
							<li><a href="#">Tickets</a></li>
							<li><a href="#">News</a></li>
							<li><a href="#">Schedule</a></li>
							<li class="search">
